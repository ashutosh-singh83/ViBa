...
const Cart = () => {
    ...
    const getinddata = async () => {
        const res = await fetch(`https://viba-backend.onrender.com/getproductsone/${id}`, {
            method: "GET",
            headers: {
    ...
    const addtocart = async (id) => {
        console.log(id);
        const check = await fetch(`https://viba-backend.onrender.com/addcart/${id}`, {
            method: "POST",
            headers: {
                Accept: "application/json",
                "Content-Type": "application/json"
                ...
                <div className="cart_container">
                    <div className="left_cart">
                        ...
                        <div className="cart_btn">
                            ...
                            <button className="cart_btn2" onClick={(e) => paymentHandler(inddata.price.cost, e)}>Buy Now</button>
                        </div>
